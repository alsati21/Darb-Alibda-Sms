...
class _NewsCardState extends State<_NewsCard> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _isExpanded = widget.news.hasAttachments;
          ...
          child: Column(
            ...
            children: [
              ...
              if (widget.news.attachmentList.isNotEmpty) ...[
                Column(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: widget.news.attachmentList.map((att) {
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Column(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  const Icon(Icons.play_circle_fill, size: 56, color: AppColors.primary),
                                  const SizedBox(height: AppSpacing.xs),
                                  Text(
                                    'مشاهدة الفيديو',
                    ...
                    return ListTile(
                      ...
                      title: Text(
                        att.fileName.isNotEmpty ? att.fileName : att.path,
                        style: Theme.of(context).textTheme.bodyMedium,
                      ),
                      trailing: TextButton(
