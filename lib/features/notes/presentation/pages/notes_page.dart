              ...
              if (selectedStudents.isEmpty)
                ...
                SizedBox(
                  ...
                  child: DropdownButtonFormField<int>(
                    isDense: true,
                    isExpanded: true,
                    value: state.selectedStudentIds.isNotEmpty
                        ? state.selectedStudentIds.first
                        : null,
                    ...
                    hint: const Text('اختر الطالب', overflow: TextOverflow.ellipsis),
                    ...
                    onChanged: (studentId) {
                      ...
                      final student = selectedStudents.firstWhere(
                        (item) => item.id == studentId,
                      );
                      context.read<NotesCubit>().toggleStudent(
                        student.id,
                        student.fullName,
                      );
                    },
